# Java_Power_Billing_System_(GUI)

## Project Overview

The **Power Billing System** is a Java-based desktop application developed using **Java Swing** and **Object-Oriented Programming (OOP)** principles. The system automates electricity bill calculation, user authentication, online payment simulation, and PDF receipt generation.
